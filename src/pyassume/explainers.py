...
The points in the residual plot should NOT be systematically getting larger or smaller \
...
The points in the residual plot should be symmetrically distributed around a horizontal line \
with a roughly constant variance.
"""
